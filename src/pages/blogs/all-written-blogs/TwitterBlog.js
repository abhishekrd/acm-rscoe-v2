...
import "./TwitterBlog.scss"
function TwitterBlog() {
    return (
        <div>
            <h1>A talk on tweet. Why Elon Musk invested in twitter ?</h1>
            <p>Elon Musk, the inventor of Tesla and SpaceX, made an offer to buy Twitter for $55 per share on April 14, 2022, and on April 26, it was announced that Twitter will be sold to him for roughly $44 billion. And  If I want to exaggerate, the figure is 44 with 9 zeros attached to it. So, that's a huge number, isn't it?

                So, why did Elon want to buy Twitter in the first place, and why did he choose Twitter over any other social media platform?

                If you do a Google search today, you will find that Facebook has over 2.93 billion users, whereas Twitter has approximately 217 million users. Before I answer why he wanted to buy Twitter, let me explain why he wanted to buy specifically Twitter over any other social media network.
                ...
                After that, in April 2007 Barack Obama saw the potential in Twitter and joined Twitter to use it as a tool for presidential elections. and this was done just because with the help of Twitter he could easily connect with people without the media clutter. And this is when twitter picked up speed due to the massive connections of Barack Obama millions of people started joining Twitter.

                Now Twitter is not the only social media platform there are numerous other platforms like youtube, Facebook, and Instagram then why did twitter succeed in the past 15 years that is because

                1) user-driven features like hashtags have now become a standard norm for searching and posting on social media.

                2) They were specific in what they are doing which builds trust between people. In the year 2017, there was a natural disaster of the hurricane in the Netherlands at that time all the emergency lines and communication channels were destroyed but people used Twitter to seek out help.
                And this is how Twitter succeeded in building itself as a brand while stealing the thunder from Facebook.
